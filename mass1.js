...
(function(){
    ...
    //必须先加载settings模块
    mass.require("settings,construct,endError,hot_deploy",function(settings,construct,endError,hot ){
        ...
        mass.require("http,fs,path,scaffold,intercepters",function(http,fs,path,scaffold,intercepters){
            if(path.existsSync(dir)){
                //     mass.settings.hasBuit = true;//已经建立此网站了，那么会在scaffold里面直接跳过没有步骤
