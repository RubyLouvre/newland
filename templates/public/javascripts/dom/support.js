...
// 特征嗅探模块 by 司徒正美
//==========================================
mass.define("support", function(){
    mass.log("已加载support模块");
    ...
    var testElementParent = body || mass.html;
...
http://help.dottoro.com/ljrobjtw.php
*/