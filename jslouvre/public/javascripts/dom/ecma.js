...
mass.define("ecma", function(){
    //mass.log("已加载ECMA262v5新扩展模块")
    //Object扩展
    //fix ie for..in bug
    var DONT_ENUM = mass.DONT_ENUM = "propertyIsEnumerable,isPrototypeOf,hasOwnProperty,toLocaleString,toString,valueOf,constructor".split(","),
    P = "prototype",
